            ...
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex space-x-6">
                    ...
                    @elseif(Auth::user()->role === 'env_police')
                        <a href="{{ route('admin.env') }}" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:underline">♻️ Env Police Dashboard</a>
                        <a href="{{ route('profile.edit') }}" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:underline">👤 Profile</a>

                    {{-- MUNICIPAL ADMIN --}}
                    @elseif(Auth::user()->role === 'municipal')
                        <a href="{{ route('admin.municipal') }}" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:underline">🛣️ Municipal Dashboard</a>
                        <a href="{{ route('profile.edit') }}" class="text-sm font-medium text-gray-700 dark:text-gray-300 hover:underline">👤 Profile</a>
